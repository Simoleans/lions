            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                    <div class="p-6">
                        ...
                        <div v-if="noFrontCamera" class="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
                            <p class="text-yellow-600 dark:text-yellow-400">
                                No se detectó una cámara frontal en su dispositivo
                            </p>
                        </div>

                        <div v-if="noRearCamera" class="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
                            <p class="text-yellow-600 dark:text-yellow-400">
                                No se detectó una cámara trasera en su dispositivo
                            </p>
                        </div>
